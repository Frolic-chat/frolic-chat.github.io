## Downloads
The latest release is **0.6.0**. Downloads are found [on the Releases page](https://github.com/Frolic-chat/Frolic/releases). See each releases' new features on its release page, or [view the full Changelog](https://github.com/Frolic-chat/Frolic/blob/master/CHANGELOG.md) to see all improvements.
