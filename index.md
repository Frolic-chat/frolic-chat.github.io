...
## Downloads
The latest release is **{{ site.latest_release }}**. Downloads are found [on the Releases page](https://github.com/Frolic-chat/Frolic/releases). See each releases' new features on its release page, or [view the full Changelog](https://frolic-chat.github.io/wiki/development/CHANGELOG.html) to see all improvements.
...
In depth documentation about Frolic can be found on the [Frolic wiki](https://frolic-chat.github.io/wiki.html). The [full changelog](https://frolic-chat.github.io/wiki/development/CHANGELOG.html) is also available.
